        ...
        <div class="jumbotron jumbotron-fluid mt-5 pt-5">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-10 offset-1 card mt-3">
                        <div class="card-body">
                            <p class="lead">I don't have enough time to update this plugin every month.<br>

                                I've developed this plugin to fit the needs that I had with my current job & the
                                different
                                websites that I've created.<br>
                                If you need a quick support or some functionalities that this plugin doesn't offer, I
                                suggest to check the paid and official plugin: <a href="https://tarteaucitron.io/">tarteaucitron.io</a><br>
                                In any case, I'll try to keep it updated with the latest version released of <a
                                        href="https://github.com/AmauriC/tarteaucitron.js/releases/" target="_blank">tarteaucitron.js</a>.
                            </p>

                            <p class="lead">
                                I'm not planing to translate this plugin. <br>
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="timeline">
                <div class="tcontainer left ongoing">
                    <div class="content">
                        <h2>When I'll have the time with my current job... (In progress)</h2>
                        <p>Keep the plugin updated with the latest release of <a
                                    href="https://github.com/AmauriC/tarteaucitron.js/releases/" target="_blank">tarteaucitron.js</a>.
                        </p>
                    </div>
                </div>
